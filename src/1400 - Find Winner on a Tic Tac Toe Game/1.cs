...
// Date solved: 12/18/2024 12:16:27 AM +00:00
// Memory: 42.5 MB
// Runtime: 0 ms
...
public class Solution {
    public string Tictactoe(int[][] moves) {
        ...
        {
            for(var r = 0; r<3; r++) {
                if (field[r, 0]==t && field[r, 1]==t && field[r, 2]==t) {
                    return true;
                }
                if (field[0, r]==t && field[1, r]==t && field[2, r]==t) {
                    return true;
                }
            }
            ...
            if (field[0, 2]==t && field[1, 1]==t && field[2, 0]==t) {
                return true;
            }
            return false;
        }
