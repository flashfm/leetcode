...
// Date solved: 11/7/2024 11:14:23 PM +00:00
// Memory: 66 MB
// Runtime: 227 ms
        ...
        for(int i = 0; i<=n; i++) {
            ...
            if (i<n) {
                ...
                while(l<r) {
                    ...
                    var idx = Array.BinarySearch(flowers, 0, n - i, m);
                    if (idx<0) {
                        idx = ~idx;
                    }
            ...
            var beauty = (long)(i + initiallyComplete) * full + min * partial;
