...
// Date solved: 11/13/2020 9:31:32 AM +00:00
// Memory: 27.6 MB
// Runtime: 104 ms
...
public class Solution {
    public bool ValidSquare(int[] p1, int[] p2, int[] p3, int[] p4) {
        ...
        */
        return l1>0 && l1==GetLen(left,rest[1]) && l1==GetLen(right,rest[0]) && l1==GetLen(right,rest[1]) && GetDotProd(left, rest[0], left, rest[1])==0;
    }
